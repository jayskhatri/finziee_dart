            ...
            child: Column(
              ...
              children: [
                ListTile(
                  ...
                  trailing: Icon(_getIconByTransactionById(_recurringTransactions[index].recurCatId), color: _getTextOrIconColorBasedOnCategoryTypeColor(_recurringTransactions[index].recurCatId??-1),),
                  onTap: () {
