...
class SelectCategoryDialog extends StatefulWidget {
  ...
  SelectCategoryDialog({super.key, required this.categories, required this.setStateInCallingPage, required this.setSelectedCategoryIndex, required this.selectedCategoryIndex, required this.selectedCategoryController});
...
class _SelectCategoryDialogState extends State<SelectCategoryDialog> {
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          ...
                          showDialog(
                            context: context,
                            builder: (context) {
                                return CreateCategoryDialog(isEditModeOn: false, categoryModel: CategoryModel(), setStateInCallingPage: widget.setStateInCallingPage, categories: widget.categories);
                            });
                        },
                      ),
                    ),
        ...
        itemBuilder: (BuildContext context, int index) {
          return Card(
            ...
            child: ListTile(
              ...
              leading: Icon(widget.categories[index].catType == 0
              ...
              onTap: () {
                setState(() {
                  ...
                  widget.selectedCategoryController.text = widget.categories[index].catName.toString();
                });
  ...
  dynamic getColorBasedOnType(int index) {
    return Colour.colorList.entries
                .firstWhere((entry) => entry.key == widget.categories[index].catColor,
                    orElse: () => MapEntry('', 0))
                .value ==
            1
        ? Colors.white
