...
class TransactionController{
  ...
  Future<List<TransactionModel>> getTransactionsByDate(DateTime fromDate, DateTime toDate) async {
    List<Map<String,dynamic>> transactions = await DBHelper.getTransactionsByDate(fromDate, toDate);
    transactionsList.assignAll(transactions.map((data) =>  TransactionModel.fromJson(data)).toList());
    return transactionsList;
  ...
  Future<double?> getAmountByDate(int type, DateTime fromDate, DateTime toDate) async {
